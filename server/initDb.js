...
db.serialize(() => {
     ...
     * 
     * Format: [name, price, description, image_path, isOnSale, salePrice, onSaleQuantity, regularInventory]
     * 
     ...
     */
    const insert = db.prepare('INSERT INTO products (name, price, description, image, isOnSale, salePrice, onSaleQuantity, regularInventory) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
